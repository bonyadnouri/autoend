...
export function ReplayPlayer({ replay, playheadMs, playing, onTogglePlay, onSeek }: Props) {
  if (replay.videoUrl) {
    return (
      <div className="card overflow-hidden">
        <video src={replay.videoUrl} controls className="aspect-video w-full bg-black" />
      </div>
    );
  }
