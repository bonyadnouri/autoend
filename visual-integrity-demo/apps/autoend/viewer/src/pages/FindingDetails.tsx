...
import { VisualIntegrityCard } from "../components/investigation/VisualIntegrityCard";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          ...
          {finding.visual && <VisualIntegrityCard visual={finding.visual} />}
            ...
            <section className="card p-5">
              ...
              <div className="mt-3">
                <ResolutionActions
                  ...
                  warningOverride={
                    finding.visual && !finding.flowId
                      ? "Accept this deviation — future Runs stop reporting this rule for this target."
                      : finding.visual?.baselineFile && finding.flowId
                        ? "Accept this visual change — the baseline screenshot will be updated to match."
                        : undefined
                  }
                />
              </div>
